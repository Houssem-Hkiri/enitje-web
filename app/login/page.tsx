    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-teal-100 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-sm p-8 rounded-lg shadow-xl relative z-10">
        ...
        <div className="text-center mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
          <h3 className="text-sm font-medium text-gray-800 mb-2">Need Access?</h3>
          <p className="text-xs text-gray-600 mb-3">
            Don't have an admin account yet? Request access to the dashboard.
          </p>
          <Link 
            href="/admin/register" 
            className="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-white bg-[#00adb5] hover:bg-[#00adb5]/90 rounded-md shadow-sm transition-colors"
          >
